...
contract('Legolas@claimBonus', function(accounts) {
  ...
  beforeEach(async function() {
    ...
    this.ADVISORS_AMOUNT =   8750000 * UNIT;
    this.FOUNDERS_AMOUNT =  26250000 * UNIT;
    this.HOLDERS_AMOUNT  = 105000000 * UNIT;
    this.RESERVE_AMOUNT  =  35000000 * UNIT;
    this.BONUS_AMOUNT    =  35000000 * UNIT;
